...
aws ec2 describe-instances --filters "Name=tag:Name,Values=lab-a2-linux" --query 'Reservations[0].Instances[0]

aws ec2 associate-iam-instance-profile --instance-id i-040a5796c899f27c7 --iam-instance-profile Name=lab-a2-diagnostic-profile --region us-east-1
i-040a5796c899f27c7

.InstanceId' --output text --region us-east-1
